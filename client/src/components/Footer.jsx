  ...
  return (
    <footer className="bg-gym-darker border-t border-gym-accent/20">
      <div className="container mx-auto px-4 py-12">
        ...
        {/* Developer Info */}
        <div className="border-t border-gym-accent/10 pt-6 pb-4">
          <div className="flex flex-col items-center gap-3">
            <p className="text-gym-light/70 text-sm">
              Developed by <span className="text-gym-accent font-semibold">Sahil Gite</span>
            </p>
            <div className="flex items-center gap-4">
              <a 
                href="https://www.linkedin.com/in/sahilgite2003?originalSubdomain=in" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gym-light/60 hover:text-gym-accent transition-colors"
                aria-label="LinkedIn"
              >
              ...
              <a 
                href="https://github.com/sahilgite1023" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gym-light/60 hover:text-gym-accent transition-colors"
                aria-label="GitHub"
              ...
              <a 
                href="https://www.instagram.com/sahilgite3/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gym-light/60 hover:text-gym-accent transition-colors"
        ...
        {/* Copyright */}
        <div className="border-t border-gym-accent/10 pt-6">
